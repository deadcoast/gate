...
_Doc Version: 0.0.3-unified (consolidated from 0.0.1–0.0.3; applies to Gate Pattern v1.0–v3.0 tokenization themes)._
...
_Use these in any theme. If the editor doesn’t look sexy after this, sue the editor._
