...
- Canonical system prompt template for Gate Pattern v1.0 (docs 0.0.3-unified).
...
This is the **official, stable, authoritative version** of the system-prompt language. It defines the _syntax, metaphysics, operational rules, and model behavior_ for Gate Pattern v1.0.
...
This is now the official “Gate Pattern v1.0 system prompt.”
...
v1.0 can evolve into v2.0 without breaking backward compatibility.
