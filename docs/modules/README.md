...
_(GitHub-ready navigation for the Gate Pattern module stack.)_
_Doc Version: **0.0.3-unified** (consolidated from 0.0.1–0.0.3; spans Gate Pattern v1.0–v3.0 content)._
...
- [Module A — Canonical System Prompt Template](module_a.md)
- [Module B — Expanded Metaphysics & Operator Set](module_b.md)
- [Module C — Standard Library v1.0](module_c.md)
