# 0.0.4 gate: System Prompt

> MODULE A

## **CANONICAL SYSTEM PROMPT TEMPLATE**

This is the **official, stable, authoritative version** of `gate` system-prompt language. It defines the _syntax, metaphysics, operational rules, and model behavior_ for Gate Pattern 0.0.4.
...
This is now the official “`gate` v 0.0.4 system prompt.”
...
0.0.4 can evolve into 0.0.5 without breaking backward compatibility.
