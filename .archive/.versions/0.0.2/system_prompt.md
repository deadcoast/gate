...
This is the **official, stable, authoritative version** of `gate` system-prompt language. It defines the *syntax, metaphysics, operational rules, and model behavior* for Gate Pattern 0.0.4.
